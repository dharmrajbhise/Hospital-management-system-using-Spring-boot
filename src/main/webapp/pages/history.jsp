...
<nav aria-label="Page navigation">
       ...
       <h1 class="text-center">History</h1>
         ...
         <div class="row g-0">
             <div class="card-body">
               <h5 class="card-title">Doctor     : ${e.doctor }</h5>
               <br>
               <p class="card-text">Complaint    : ${e.complaints }</p>
               <p class="card-text">Lab Result   : ${e.labresults}</p>
               <p class="card-text">Observations : ${e.observations }</p>
               <p class="card-text">Diagnosis    : ${e.diagnosis }</p>
